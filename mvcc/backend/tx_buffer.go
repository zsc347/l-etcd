...
func (txr *txReadBuffer) Range(bucketName,
	key,
	endKey []byte,
...
func (txr *txReadBuffer) ForEach(bucketName []byte,
...
// unsafeCopy returns a copy of txReadBuffer, caller should acquire
// backend.readTx.RLock()
...
func (bb *bucketBuffer) Range(key, endKey []byte,
