...
type ReadView interface {
	...
	// The returned rev is the current revision of the KV when the operations is executed.
...
type WriteView interface {
	...
	// A deleteRange increates the rev of the store if any key in the range exists.
	// The number of the key deleted will be returned.
	...
	// Put puts the given key, value into the store. Put also takes additional argument
	// lease to attach a lease to a key-value pair as meta-data. KV implementation does not
...
// If the consistent index of executing entry is not larger than the consistent
// index of ConsistentWatchableKV, all operations in this entry are skipped and
